...
game.currentScene().eventContext.registerFrameHandler(19, () => {
    if ((controller.left.isPressed() && angle >= 0) || (controller.right.isPressed() && angle <= 180)) {
        ...
        verticalTargetingAide.drawLine(targetingAideMidpoint, targetingAideMidpoint, points[0].x, points[0].y, 3);
        verticalTargetingAide.drawLine(points[1].x, points[1].y, points[2].x, points[2].y, 3);
        verticalTargetingAide.drawLine(points[1].x, points[1].y, points[0].x, points[0].y, 3);
        verticalTargetingAide.drawLine(points[2].x, points[2].y, points[0].x, points[0].y, 3);
    }
});
